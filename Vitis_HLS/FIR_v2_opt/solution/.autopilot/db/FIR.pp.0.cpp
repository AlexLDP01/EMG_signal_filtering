...
# 1 "FIR_v2_opt/src/FIR.h" 1



# 1 "FIR_v2_opt/src/config.h" 1
# 10 "FIR_v2_opt/src/config.h"
...
# 11 "FIR_v2_opt/src/config.h" 2
# 20 "FIR_v2_opt/src/config.h"
typedef ap_fixed<24, 1, AP_RND_CONV, AP_SAT, 1> TL_data;



typedef ap_fixed<18, 1, AP_RND_CONV, AP_SAT, 1> TL_coef;



typedef ap_fixed<32, (1+6), AP_RND_CONV, AP_SAT, 1> TL_acum;


const TL_coef FIR_coefs[64] = {
...
# 6 "FIR_v2_opt/src/FIR.h" 2

__attribute__((sdx_kernel("FIR_filter", 0))) void FIR_filter(hls::stream<TL_data>& data_in_stream, hls::stream<TL_acum>& data_out_stream);
# 10 "FIR_v2_opt/src/FIR.cpp" 2
# 1 "FIR_v2_opt/src/config.h" 1
# 11 "FIR_v2_opt/src/FIR.cpp" 2

__attribute__((sdx_kernel("FIR_filter", 0))) void FIR_filter(hls::stream<TL_data>& data_in_stream, hls::stream<TL_acum>& data_out_stream) {
#line 19 "E:/ALEX/UNIVERSIDAD/TFG_Workspace/HLS/FIR_v2_opt/solution/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=FIR_filter
# 12 "FIR_v2_opt/src/FIR.cpp"

#line 6 "E:/ALEX/UNIVERSIDAD/TFG_Workspace/HLS/FIR_v2_opt/solution/directives.tcl"
#pragma HLSDIRECTIVE TOP name=FIR_filter
# 12 "FIR_v2_opt/src/FIR.cpp"
...
#pragma HLS INTERFACE mode=axis register_mode=both depth=1 port=data_in_stream register
 ...
 static TL_data fir_shift_reg[64];
#pragma HLS ARRAY_PARTITION dim=1 type=complete variable=fir_shift_reg
 shift_reg : for (int i = 64 -1; i > 0; i--) {
#pragma HLS UNROLL
 fir_shift_reg[i] = fir_shift_reg[i - 1];
    }
    fir_shift_reg[0] = (TL_data)(data_in_stream.read());
# 40 "FIR_v2_opt/src/FIR.cpp"
...
#pragma HLS UNROLL factor=4
 VITIS_LOOP_49_1: for(int k = 0; k < 64/UR; k++)
     {
#pragma HLS PIPELINE
 acum[i] = TL_acum(acum[i] + TL_acum(fir_shift_reg[k + i*64/UR] * FIR_coefs[k + i*64/UR]));
     }
    ...
    {
#pragma HLS PIPELINE
 total = TL_acum(total + acum[i]);
    }
    data_out_stream.write(total);
